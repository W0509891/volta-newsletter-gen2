    ...
    return (
        <div className="space-y-6">
            ...
            <div
              ...
              <span
                  className="text-xs px-2 py-0.5 rounded font-bold uppercase bg-slate-800 text-slate-300 border border-slate-700">
                {item.status}
              </span>
                ...
                <div className="space-y-6">
                    ...
                    <div className="bg-slate-900 border border-slate-800 rounded-xl p-6 space-y-4">
                        ...
                        {approvalUrl && (
                            <div className={"flex items-center gap-0"}>
                                ...
                                <button
                                    ...
                                    className={"text-xs px-2.5 py-1 rounded bg-amber-500/20 text-amber-300 hover:bg-amber-500/30 border border-amber-500/30 font-medium"}>Copy
                                </button>
                            </div>
                        )}

                        {
                            !approvalUrl && (
                                <>
                                    {/*todo: IS NOT IDEMPOTENT IN MAKING LINKS*/}
                                    <button
                                        type="button"
            ...
            {showConsentModal && (
                <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-xs p-4">
                    <div
                        className="bg-slate-900 border border-slate-800 rounded-xl max-w-md w-full p-6 text-white shadow-2xl space-y-4">
